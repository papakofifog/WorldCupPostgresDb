...
echo  "$($PSQL "select name from games left join teams as t on games.winner_id=t.team_id or games.opponent_id=t.team_id where year=2014 and round='Eighth-Final' order by name")"
